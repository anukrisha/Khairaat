...
<head>
  ...
  <script type="text/javascript">
    function validate()
    {
      ...
      if(document.loginform.password.value==""||document.loginform.password.value.length!=6){
...
<body>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
          <form action="checklogin.php" method="post" role="form"name="loginform"onsubmit="return(validate());" > <!-- add action here -->
              <div class="row">
  ...
  padding: 10px 24px;
  color: #fff;
  transition: 0.4s; " type="submit" >Login</button></div>
