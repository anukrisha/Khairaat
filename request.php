  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <center>
            <form action="requested.php"name="requestform" method="post" role="form"class="request"style="margin:auto;max-width:300px"onsubmit="return(validate());">
             <div>
              
              <br/>
              <div>
              <input type="text" class="form-control" placeholder="Search Book Name" name="search"id="search">
              </div>
